...
.. index:: control instructions, structured control, label, block, branch, result type, value type, block type, label index, function index, event index, type index, vector, polymorphism, LEB128
