...
(module
  ...
  (func (export "catch-complex-1") (param i32) (result i32)
    (block $h1 (result exnref)
      (try (result i32) (catch $e1 $h1)
        (block $h0 (result exnref)
          (try (result i32) (catch $e0 $h0)
  ...
  (func (export "catch-complex-2") (param i32) (result i32)
    (block $h0 (result exnref)
      (block $h1 (result exnref)
        (try (result i32) (catch $e0 $h0) (catch $e1 $h1)
          (if (i32.eqz (local.get 0))
            (then (throw $e0))
            (else
              (if (i32.eq (local.get 0) (i32.const 1))
  ...
  (func (export "catch-imported") (result i32)
    (block $h (result exnref)
      (try (result i32) (catch $imported-e0 $h)
  ...
  (func (export "catchless-try") (param i32) (result i32)
    (block $h (result exnref)
      (try (result i32) (catch $e0 $h)
        (try (result i32) (call $throw-if (local.get 0)))
      )
      (return)
    )
    (drop) (i32.const 1)
...
(assert_malformed
  (module quote
    "(module (func (try (catch_all 0) (catch_all 0))))"
  )
  "unexpected token"
)

(assert_invalid
  (module (func (result i32) (try (result i32))))
  "type mismatch"
)
(assert_invalid
  (module (func (result i32) (try (result i32) (i64.const 42))))
  "type mismatch"
)

(assert_invalid
  (module (tag) (func (try (catch 0 0))))
  "type mismatch"
)
(assert_invalid
  (module
    (tag (param i64))
    (func (result i32 exnref) (try (result i32) (catch 0 0) (i32.const 42)))
  )
  "type mismatch"
)
