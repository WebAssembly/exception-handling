...
(module
  ...
  (func (export "empty-catch") (try (do) (catch $e0 (drop))))
  ...
  (func (export "unreachable-not-caught") (try (do (unreachable)) (catch_all (drop))))
  ...
  (func (export "catch-imported") (result i32)
    (try (result i32)
      ...
      (catch $imported-e0 (drop) (i32.const 2))
    )
  )
...
(assert_invalid (module (tag) (func (try (do) (catch 0 (drop) (i32.const 42)))))
                "type mismatch: block requires [] but stack has [i32]")
(assert_invalid (module
                  (tag (param i64))
                  (func (result i32)
                    (try (result i32) (do (i32.const 42)) (catch 0 (drop)))))
                "type mismatch: instruction requires [i32] but stack has [i64]")
(assert_invalid (module (func (try (do) (catch_all (drop) (i32.const 42)))))
                "type mismatch: block requires [] but stack has [i32]")
